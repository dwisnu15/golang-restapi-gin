...
func NewAuthorization(reason string) *CustomError {
	return &CustomError{
		Type:    Authorization,
		Message: reason,
	}
...
func NewBadRequest(reason string) *CustomError {
	return &CustomError{
		Type:    BadRequest,
...
func NewConflict(name string, value string) *CustomError {
	return &CustomError{
		Type:    Conflict,
...
func NewNotFound(name string, value string) *CustomError {
	return &CustomError{
		Type:    NotFound,
...
func NewPayloadTooLarge(maxBodySize int64, contentLength int64) *CustomError {
	return &CustomError{
...
func NewServiceUnavailable() *CustomError {
	return &CustomError{
...
func NewUnsupportedMediaType(reason string) *CustomError {
	return &CustomError{
