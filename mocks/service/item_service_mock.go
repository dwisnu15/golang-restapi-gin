...
//mock item service
type ItemsServiceMock struct {
	mock.Mock //type embedding
}

type MockServiceLayer interface {
...
func (m *ItemsServiceMock) FindAllItem() (*[]models.Items, error) {
...
func (m *ItemsServiceMock) FindItemByID(itemID int64) (*models.Items, error) {
	ret := m.Called(itemID)
...
func (m *ItemsServiceMock) InsertItem(newItem *models.CreateItemInput)  bool {
...
func (m *ItemsServiceMock) UpdateItem(id int64, updateItem *models.UpdateItemInput) bool {
...
func (m *ItemsServiceMock) DeleteItem(id int64) bool {
	ret := m.Called(id)
	err := ret.Error(0)
	if err != nil {
		return false
